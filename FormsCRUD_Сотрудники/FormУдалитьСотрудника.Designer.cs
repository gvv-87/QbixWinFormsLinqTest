namespace QbixWinFormsLinqTest
{
    partial class FormУдалитьСотрудника
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FormУдалитьСотрудника));
            ...
            this.textBox_ТекущееФио.Location = new System.Drawing.Point(27, 52);
            ...
            // 
            // FormУдалитьСотрудникаСотрудника
            // 
            ...
            this.Name = "FormУдалитьСотрудникаСотрудника";
